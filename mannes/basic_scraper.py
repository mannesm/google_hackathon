...
def basic_scraper(medication_name: str) -> tuple[str, str]:
    ...
    try:
        ...
        return bijwerkingen_text, doseringen_text
    except requests.exceptions.RequestException as err:
        print("Oops! Something went wrong:", err)
        return 'No medication details found', 'No medication details found'  # Return an empty tuple on any exception


def scrape_medications(medications_dict: Dict[str, list]) -> Dict[str, Dict[str, str]]:
    """Scrapes side effects and dosage information for a list of medications.

    Args:
        medications_dict (Dict[str, list]): A dictionary where the key is "medicijnen" and the value is a list of medication names.
    ...
    for medicine in medications_dict["medicijnen"]:
        bijwerking, dosering = basic_scraper(medicine.lower())
        bijwerkingen_dosering[medicine] = {"bijwerkingen": bijwerking, "dosering": dosering}
